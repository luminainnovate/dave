...
10. **Dynamic Settings Fallback**: The Orchestrator applies specialized `temperature` and `presence_penalty` values only to the default `qwen3.8:27b` model. For any third-party expert model, it reverts to standard defaults to ensure stability.
